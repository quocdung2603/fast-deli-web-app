  ...
  return (
    ...
    >
      <div className="flex items-center space-x-2">
        <img src={Logo} alt="G-EASY English Logo" className="w-9 h-9 ml-1.5" />
        {collapse && (
          <div>
            <p className="text-xs font-bold text-black">ABC Delivery</p>
      ...
      <div className="w-full flex flex-col justify-center space-y-5 relative">
